  ...
  return (
    ...
    <div className='home'>
      <div className='home1'>
       ...
       <div>
        <Link className='book1'to='/home/book'><p>Book Now</p></Link>
       </div>
       <Slide i={i}/>
       </div>
       ...
       <div>
        <Link to='/home/book' className='book'><p>Book Now</p></Link>
       </div>
       <Slide1 j={j}/>
       </div>
       <div className='arrow2'>
            ...
            <div>
        <Link className='book' to='/home/book'><p>Book Now</p></Link>
       </div>
            <Slide2 k={k}/>
            </div>
